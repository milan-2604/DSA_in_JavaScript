...
Output: 8
Explanation: Between each of the following device pairs, there is one beam. In total,
 there are 8 beams:
 * bank[0][1] -- bank[2][1]
 * bank[0][1] -- bank[2][3]
 * bank[0][2] -- bank[2][1]
...
var numberOfBeams = function(bank) {
    ...
    let a =0; let b =1;
    while(b<bank.length){
        const checkOneA = checkOne(bank[a]);
        const checkOneB = checkOne(bank[b]);
        if(checkOneA===0){
            a++;
            b++;
        }else if(checkOneB===0){
