...
bank.transfer(5, 1, 20); // return true, account 5 has a balance of $30, so it is valid 
// to transfer $20.
...
//         if(account1>this.Balance.length || account2>this.Balance.length|| account1<1|| account2<1) return false;
...
//         if(account>this.Balance.length|| account<1) return false;
...
Bank.prototype.transfer = function(account1, account2, money) {
    if(account1<1 || account2<1 || account1>this.balance.length || account2>this.balance.length) return false;
    if(this.balance[account1-1]<money) return false;
    this.balance[account1-1]-=money;
    this.balance[account2-1]+=money;
    return true;
...
console.log(bank);
console.log(bank.transfer(5,1,10));
console.log(bank);
